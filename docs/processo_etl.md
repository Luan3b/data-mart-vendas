...
**Dica para salvar direto no Linux/Bash:**

Se preferir sobrescrever o arquivo diretamente pelo terminal sem risco de perder as quebras de linha:

```bash
cat << 'EOF' > docs/ETL_PROCESS.md
# Documentação do Processo ETL (Extract, Transform, Load)
